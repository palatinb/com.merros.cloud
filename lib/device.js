...
class Device extends Homey.Device {
  var clientResponseTopic = null;
  var waitingMessageIds = {};
  var domain = null;
  var uuid = null;
  var key = null;
  var userId = null;
  ...
  onInit() {
    console.log(this);
    this.domain = this.getData().domain;
    ...
    const domain = this.domain || "eu-iot.meross.com";
    const clientId = 'app:' + appId;

    //This listens to changes of the capability // ez arész SZAR
    //TODO rewrite the listener
    ...
    this.on('data', (namespace, payload) => {
      //ezt kell megnéznem hogy itt mi történik
